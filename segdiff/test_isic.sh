...
CUDA_VISIBLE_DEVICES=0 srun apptainer exec --nv /oscar/runtime/software/external/ngc-containers/pytorch.d/x86_64.d/pytorch-24.03-py3 python val_isic.py  --model_path /users/xwang259/CSCI1430-Final-Project-MedImage-Segmentation/CSCI1430-Final-Project-MedImage-Segmentation/logs/2024-05-13-01-23-09-042170_vaih_256_6_0.0001_4_100_0.1_0/model_7000.pt
